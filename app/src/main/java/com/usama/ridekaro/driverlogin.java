...
public class driverlogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegProgress = new ProgressDialog(driverlogin.this);
        ...
        mLogin_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.isEmpty() || password.isEmpty()){
                    ...
                    mRegProgress.setMessage("Please wait while we are verifying You !");
                            ...
                            if (task.isSuccessful()) {
                                mUserDatabase.child(current_user_id).child("device_token").setValue(Objects.requireNonNull(task.getResult()).getToken()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Intent mainIntent = new Intent(driverlogin.this, driverDash.class);
                                ...
                                Toast.makeText(driverlogin.this, "Error - " +task.getException().toString(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
